namespace Entorns___Git_TaulaLlista
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            #region CLASS CODE - IGNORE

            //Console.WriteLine("IN-CLASS OUTPUT CODE");
            //Console.WriteLine(" ");
            ...
            //int[] taulaEnters = { 56, 11, 10, 9 };
            //Console.WriteLine(taulaEnters.Sum());
            ...
            //IEnumerator<int> cursor = t.GetEnumerator();
